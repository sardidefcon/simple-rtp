...
| Command | Description |
|---------|-------------|
| `/rtp` | Teleports the player to a random safe location within the configured radius |
...
- **cost-enabled** / **cost-amount**: When cost is enabled, player must pay the amount (requires Vault + economy plugin)
